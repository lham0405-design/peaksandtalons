...
public final class ModItems {
 ...
 public static final DeferredItem<TrollHeartItem> HEART_OF_ORDUK=ITEMS.registerItem("heart_of_orduk",p->new TrollHeartItem(p.rarity(Rarity.EPIC).stacksTo(1).fireResistant()));
