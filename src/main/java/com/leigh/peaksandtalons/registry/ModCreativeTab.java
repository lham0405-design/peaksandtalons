...
public final class ModCreativeTab {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAIN = TABS.register("main", () -> CreativeModeTab.builder()
        ...
        .displayItems((parameters, output) -> {
            output.accept(ModItems.EAGLE_SPAWN_EGG.get()); output.accept(ModItems.EAGLE_FEATHER.get()); output.accept(ModItems.EAGLE_TALON.get());
            ...
            output.accept(ModItems.GOLDEN_EAGLE_HARNESS.get()); output.accept(ModItems.TROLL_HEART.get());
