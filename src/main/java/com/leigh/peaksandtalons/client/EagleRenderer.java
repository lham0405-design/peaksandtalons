...
public class EagleRenderer extends MobRenderer<EagleEntity,EagleModel>{
 ...
 public EagleRenderer(EntityRendererProvider.Context c){super(c,new EagleModel(c.bakeLayer(EagleModel.LAYER_LOCATION)),1.45F);}
 @Override protected void scale(EagleEntity e,PoseStack p,float pt){p.scale(2.12F,2.12F,2.12F);}
